...
gridLineColor = 'lavender' # line color of grids
backgroundColor = 'whitesmoke' # background color of plots
dpi = 100 # figure resolution
legendFontSize = 12 # legend font size
xTickSize = 24 # x tick font size
yTickSize = 24 # y tick font size
axisLabelSize = 28 # font size of axes
titleLabelSize = 28 # font size of main title
...
axesOff = ['top'] # Write down the axes you wish to turn off. Acceptable inputs: 'top', 'bottom', 'right', 'left'.
