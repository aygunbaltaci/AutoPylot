...
color_line1 = 9 # color of the 1st line on the plot. Valid values are: 0: blue, 1: orange, 2: green, 3: red, 4: purple, 5: brown, 6: pink, 7: dark grey, 8: light green, 9: cyan
color_line2 = 3 # color of the 2nd line on the plot. Valid values are: 0: blue, 1: orange, 2: green, 3: red, 4: purple, 5: brown, 6: pink, 7: dark grey, 8: light green, 9: cyan
