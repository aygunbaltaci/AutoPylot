...
defaultLegendNames = ['Dark Scene', 'Noise Scene', 'DJI Spark - Waypoint', 'DJI Spark - Formula', 'DJI Spark - UL', 'DJI Mavic Air - UL', 'Parrot AR - UL', 'DJI Spark - UL - Formula', 'legend9', 'legend10'] # PER LINE, NOT PER PLOT. Default legend names
...
snsLine_lineWidth = [15, 15, 15, 5, 5, 5, 5, 3, 1, 1] # PER LINE, NOT PER PLOT. line width for lines per plots. First entry of array is the first input data. Increase array size if you plot more than 10 lines in a plot! 
...
snsLine_markerSize = [15, 30, 15, 15, 10, 1, 1, 1, 1, 1] # PER LINE, NOT PER PLOT. marker size. 
