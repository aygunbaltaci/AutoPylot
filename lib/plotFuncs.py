        ...
        if plotSelect == 'bar':
            ...
            if config.multipleAxis: # multiple-axis enabled
                ...
                if plotPlotSelect[0] == 1: # line plot
                    ...
                    p[0] = self.host[self.figColCnt, self.figRowCnt].scatter(data[colNumX[0]], data[colNumY[0]], c = self.colors[config.lineColors[0]], label = legendName[0])  
                ...
                for i in range(1, numData):
                    ...
                    if plotPlotSelect[0] == 1: # line plot
                        ...
                        p[i] = self.guest[j].scatter(data[colNumX[i]], data[colNumY[i]], c = self.colors[config.lineColors[i]], label = legendName[i])  
                    elif plotPlotSelect[0] == 3: # line+scatter plot
                        p2.append(0) #initialize array entry
