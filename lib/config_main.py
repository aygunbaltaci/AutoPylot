...
legend_bbox_to_anchor = (0.5, -0.4) # !!! IF SET, ONLY THE LEGENDS OF LAST PLOT WILL BE USED !!! Place legend in a specific box configuration. Use 'None' for default. Format: '(x, y) or (x, y, w, h)'. Check out: https://matplotlib.org/api/_as_gen/matplotlib.pyplot.legend.html
legend_loc = "center"
...
defaultLegendNames = ['PS - Orig. Data', 'PS - Link 1', 'PS - Link 2', 'PD - Orig. Data', 'PD - Link 1', 'PD - Link 2', 'legend7', 'legend8', 'legend9', 'legend10'] # Default legend names
defaultSubTitleNames = ['\\textbf{Packet Interval - Uplink}', '\\textbf{Packet Interval CDF Analysis}', 'subtitle3', 'subtitle4', 'subtitle5', 'subtitle6', 'subtitle7', 'subtitle8', 'subtitle9', 'subtitle10'] # Default subtitle names
