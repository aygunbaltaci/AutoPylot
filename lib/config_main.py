...
############ Inputs for Plots 
lineWidth = [5, 5, 5, 1, 1, 1, 1, 1, 1, 1] # line width of line plots. First entry of array is the first input data. Increase array size if you plot more than 10 lines in a plot! 
...
lineStyle = ['-', '-', 'dashed', 'dashed', '-', '-', '-', '-', '-', '-'] # valid inputs are: '-', '--', '-.', ':', 'None', ' ', '', 'solid', 'dashed', 'dashdot', 'dotted'
