...
defaultLegendNames = ['DJI Spark', 'DJI Mavic Air', 'Parrot AR', 'DJI Spark - Formula', 'DJI Spark - UL', 'DJI Mavic Air - UL', 'Parrot AR - UL', 'DJI Spark - UL - Formula', 'legend9', 'legend10'] # PER LINE, NOT PER PLOT. Default legend names
defaultSubTitleNames = ['\\textbf{Downlink PDF Analysis}', '\\textbf{Uplink PDF Analysis}', '', '', '', '', 'subtitle7', 'subtitle8', 'subtitle9', 'subtitle10'] # Default subtitle names
...
yticks = [(None, None, None), (None, None, None), (None, None, None), (None, None, None), (None, None, None), (None, None, None), (None, None, None), (None, None, None), (None, None, None), (None, None, None)] # set spacing of yticks. 
...
scaleX = ['linear', 'linear', 'log', 'log', 'linear', 'linear', 'linear', 'linear', 'linear', 'linear'] # Scale of x-axes. Valid inputs are: 'linear', 'log', 'symlog', 'logit', ... check out https://matplotlib.org/3.1.1/api/_as_gen/matplotlib.axes.Axes.set_yscale.html
...
cdf_lineStyle = ['solid', 'dashed', '-.', 'dashed', 'solid', 'solid', 'solid', 'dashed', '', ''] # linestyle per plot. Valid inputs: {'-', '--', '-.', ':', 'None', ' ', '', 'solid', 'dashed', 'dashdot', 'dotted'}
cdf_markerStyle = ['', '', '', '', 'x', '', '', '', '', ''] # PER LINE, NOT PER PLOT. marker style. For acceptable inputs, check out https://matplotlib.org/api/markers_api.html#module-matplotlib.markers
